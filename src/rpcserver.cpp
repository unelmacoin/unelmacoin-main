...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop unelmacoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "unelmacoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* unelmacoin features */
        {"unelmacoin", "masternode", &masternode, true, true, false},
        {"unelmacoin", "masternodelist", &masternodelist, true, true, false},
        {"unelmacoin", "mnbudget", &mnbudget, true, true, false},
        {"unelmacoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"unelmacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"unelmacoin", "mnsync", &mnsync, true, true, false},
        {"unelmacoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"unelmacoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use unelmacoind, or the -server option to unelmacoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> unelmacoin-cli " + methodname + " " + args + "\n";
}
