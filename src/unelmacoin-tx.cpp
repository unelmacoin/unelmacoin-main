...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("unelmacoin Core unelmacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  unelmacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unelmacoin transaction") + "\n" +
                               "  unelmacoin-tx [options] -create [commands]   " + _("Create hex-encoded unelmacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unelmacoin transaction
