...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("unelmacoin Core"),
     ...
     * override -datadir in the unelmacoin.conf file in the default data directory
     * (to be consistent with unelmacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
