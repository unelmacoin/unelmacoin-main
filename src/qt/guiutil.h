...
/** Utility functions used by the unelmacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render unelmacoin addresses in monospace font
...
// Parse "unelmacoin:" URI into recipient object, return true on successful parsing
