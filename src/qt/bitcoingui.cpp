                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UnelmaCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a unelmacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unelmacoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Unelmacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Unelmacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for unelmacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your unelmacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified unelmacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a unelmacoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Unelmacoin Core help message to get a list with possible unelmacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Unelmacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to unelmacoin network", "", count));
}
...
{
    QString strTitle = tr("Unelmacoin Core"); // default title
