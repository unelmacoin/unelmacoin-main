...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a unelmacoin address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no unelmacoin: URI
...
{
    // Convert unelmacoin:// to unelmacoin:
    //
    //    Cannot handle this later, because unelmacoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open unelmacoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "unelmacoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for unelmacoin.lnk
...
{
    return GetAutostartDir() / "unelmacoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a unelmacoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=unelmacoin\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the unelmacoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add unelmacoin app to startup item list
