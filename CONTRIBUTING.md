Contributing to unelmacoin Core
============================

The unelmacoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the unelmacoin Core project, and is not to be
confused with overall unelmacoin Network Protocol consensus changes.

Whether a pull request is merged into unelmacoin Core rests with the project merge
...
Patches that change unelmacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the unelmacoin consensus, it must have been
...
The project leader is the release manager for each unelmacoin Core release.
