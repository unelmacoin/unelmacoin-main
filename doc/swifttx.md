...
This mechanism has been integrated into Bitcore-Node-unelmacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unelmacoin-Project/insight-api-unelmacoin#web-socket-api](https://github.com/unelmacoin-Project/insight-api-unelmacoin#web-socket-api) 
* API: [https://github.com/unelmacoin-Project/insight-api-unelmacoin#swifttx-transactions](https://github.com/unelmacoin-Project/insight-api-unelmacoin#swifttx-transactions) 
...
By default, the unelmacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the unelmacoin Core daemon:
