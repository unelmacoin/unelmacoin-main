...
unelmacoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<unelmacoin_address\> \<monthly_payment_unelmacoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ unelmacoin, _12_ times over the course of a year totaling _24000_ unelmacoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<unelmacoin_address\> \<monthly_payment_unelmacoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` unelmacoin.
 ...
 * vote-many          - Vote on a unelmacoin initiative
 * vote-alias         - Vote on a unelmacoin initiative
 * vote               - Vote on a unelmacoin initiative/budget
