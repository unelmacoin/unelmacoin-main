...
In order to support loading of multiple wallets in unelmacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is unelmacoin.cpp.
...
Changes to unelmacoin.cpp
----------------------
unelmacoin.cpp is the entry point into unelmacoin-qt, and as such, will require some minor modifications to provide hooks for
